...
% FltBuf2 = [(Time + h_step), FltSdt_F, CtrlSdt_B, CtrlSdt_P,sigma];%%全部的状态量1+9+6+12+2=30
...
% hold on
% grid on
% plot(T,alpha*Rad2Deg,'-.b','LineWidth',2); 
% % figure(14);
...
% plot(T,Cmd_alp*Rad2Deg,'-r','LineWidth',2);        
% hold on
% plot(T,Cmd_bet*Rad2Deg,'--g','LineWidth',2);
...
% grid on;
% xlabel('Time (s)','FontSize',12);
% ylabel('comd-angle (deg)','FontSize',12);
% h1=legend('\alpha','\beta','\mu','Location','SouthEast');
% set(h1,'box','off');
% 
% figure(2);
% % plot(T,Height,'-.r','LineWidth',2); 
