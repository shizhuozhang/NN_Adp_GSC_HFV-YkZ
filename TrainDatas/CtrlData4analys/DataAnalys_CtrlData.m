...
% load CtrlData_2_0_1.mat;
% load CtrlData_3_0_1.mat;
% load CtrlData_4_0_1.mat;
 load CtrlData_5_0_1.mat;

% load CtrlData_1_5_16.mat;
% load CtrlData_2_5_16.mat;
%  load CtrlData_3_5_16.mat;
%  load CtrlData_4_5_16.mat;
%  load CtrlData_5_5_16.mat;

% load CtrlData_1_10_16.mat;
%  load CtrlData_2_10_16.mat;
%  load CtrlData_3_10_16.mat;
% load CtrlData_4_10_16.mat;
%  load CtrlData_5_10_16.mat;
% 
% load CtrlData_1_20_16.mat;
%  load CtrlData_2_20_16.mat;
% load CtrlData_3_20_16.mat;
% load CtrlData_4_20_16.mat;
%  load CtrlData_5_20_16.mat;
...
%% 俯仰通道
figure(1);
% plot(T,Ero_alp*Rad2Deg,'-b','LineWidth',2); %%  -b  --g  :r  -.c  -m
% plot(T,Ero_alp*Rad2Deg,'--g','LineWidth',2);
% plot(T,Ero_alp*Rad2Deg,':r','LineWidth',2);
 %plot(T,Ero_alp*Rad2Deg,'-.c','LineWidth',2);
plot(T,Ero_alp*Rad2Deg,'-m','LineWidth',2);
grid on
...
% 
figure(10);
plot(T,Acc_pit*Rad2Deg,'-b','LineWidth',2); 
grid on
xlabel('Time (s)','FontSize',12);
...
% grid on
% xlabel('Time (s)','FontSize',12);
% ylabel('Ero_{mu} (deg)','FontSize',12);
% hold on
% 
% % figure(6);
...
% % grid on
% % xlabel('Time (s)','FontSize',12);
% % ylabel('Ero_{pw} (deg)','FontSize',12);
% 
% figure(12);
% plot(T,Acc_rol*Rad2Deg,'-b','LineWidth',2); 
% grid on
% xlabel('Time (s)','FontSize',12);
% ylabel('Acc_{rol} (deg)','FontSize',12);
% hold on
...
% grid on
% xlabel('Time (s)','FontSize',12);
% ylabel('Dlt_{mu} (deg)','FontSize',12);
